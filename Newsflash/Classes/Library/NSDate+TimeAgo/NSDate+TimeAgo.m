...
+ (NSString *) timeAgoSimpleForSeconds:(double) deltaSeconds {
...
- (NSString *)timeAgoSimple
{
    ...
    if(deltaSeconds < 60)
    {
        return [NSDate stringFromFormat:@"%%d%@s" withValue:deltaSeconds];
    }
    else if (deltaMinutes < 60)
    {
        return [NSDate stringFromFormat:@"%%d%@m" withValue:deltaMinutes];
    }
    else if (deltaMinutes < (24 * 60))
    {
        value = (int)floor(deltaMinutes/60);
        return [NSDate stringFromFormat:@"%%d%@h" withValue:value];
    }
    else if (deltaMinutes < (24 * 60 * 7))
    {
        value = (int)floor(deltaMinutes/(60 * 24));
        return [NSDate stringFromFormat:@"%%d%@d" withValue:value];
    }
    else if (deltaMinutes < (24 * 60 * 31))
    {
        value = (int)floor(deltaMinutes/(60 * 24 * 7));
        return [NSDate stringFromFormat:@"%%d%@w" withValue:value];
    }
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
        value = (int)floor(deltaMinutes/(60 * 24 * 30));
        return [NSDate stringFromFormat:@"%%d%@mo" withValue:value];
    }
    
    value = (int)floor(deltaMinutes/(60 * 24 * 365));
    return [NSDate stringFromFormat:@"%%d%@yr" withValue:value];
}
...
- (NSString *)timeAgo
{
    ...
    {
        return [NSDate stringFromFormat:@"%%d %@seconds ago" withValue:deltaSeconds];
    }
    ...
    {
        return [NSDate stringFromFormat:@"%%d %@minutes ago" withValue:deltaMinutes];
    }
    ...
    else if (deltaMinutes < (24 * 60))
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@hours ago" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 7))
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@days ago" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 31))
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@weeks ago" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@months ago" withValue:minutes];
    }
    ...
    return [NSDate stringFromFormat:@"%%d %@years ago" withValue:minutes];
}
...
- (NSString *)dateTimeAgo
{
    ...
    if (components.year >= 1)
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@years ago" withValue:components.year];
    }
    else if (components.month >= 1)
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@months ago" withValue:components.month];
    }
    else if (components.weekOfYear >= 1)
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@weeks ago" withValue:components.weekOfYear];
    }
    else if (components.day >= 1)    // up to 6 days ago
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@days ago" withValue:components.day];
    }
    else if (components.hour >= 1)   // up to 23 hours ago
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@hours ago" withValue:components.hour];
    }
    else if (components.minute >= 1) // up to 59 minutes ago
    {
        ...
        return [NSDate stringFromFormat:@"%%d %@minutes ago" withValue:components.minute];
    }
    ...
    return [NSDate stringFromFormat:@"%%d %@seconds ago" withValue:components.second];
}
...
{
    NSString * localeFormat = [NSString stringWithFormat:format, [NSDate getLocaleFormatUnderscoresWithValue:value]];
